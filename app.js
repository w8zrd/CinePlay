...
const closeModal = () => { $('modal-overlay').setAttribute('hidden',''); document.body.style.overflow=''; };
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.addEventListener('keydown', e=>{ if(e.key==='Escape'&&!$('modal-overlay').hasAttribute('hidden')) closeModal(); });
